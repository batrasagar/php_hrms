...
requireLogin();
requirePermission('report_swipe.view');
...
.sw-wo { background: #e2e3e5; color: #555; }
...
(function () {
  ...
  function renderCell(c) {
    ...
    if (c.type === 'WO')  return ['sw-day sw-wo', '<span class="sw-badge sw-wo">WO</span>'];
